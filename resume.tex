...
%%% Essentials
\name{Vanzaghi}{Axel}
\address{46B Boulevard des Minimes, appartement 131, 31200 Toulouse, France}
\mobile{(+33) 6 15 23 93 88}
%%% Social
\email{axel.vanzaghi@axellink.fr}
\github{axellink}
\linkedin{axel-vanzaghi-127a871a9}
%%% Optionals
\position{SRE - Software Developper}
%\quote{``No quote."}
...
\import{\sectiondir}{open_source_projects.tex}
